  ...
  return (
    <SafeAreaView style={[styles.safeArea, isWeb && styles.webSafeArea]}>
      ...
      <ScrollView contentContainerStyle={[styles.content, isWeb && styles.webContent]}>
        <Text style={[styles.title, isRTL && styles.rtlText]}>{menuStrings.support}</Text>
        <Text style={[styles.paragraph, isRTL && styles.rtlText]}>{menuStrings.supportDescription}</Text>
      </ScrollView>
    </SafeAreaView>
  );
};
